...
abstract contract BlackList is Ownable, BasicToken {
    ...
    /////// Getters to allow the same blacklist to be used also by other contracts (including upgraded ExampleToken) ///////
...
contract USDTTestToken is Pausable, StandardToken, BlackList {
    ...
    function transfer(address _to, uint _value) public whenNotPaused override(BasicToken, ERC20Basic) {
